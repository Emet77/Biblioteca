...
class view_btn_delete_partner():
    ...
    def frame_delete_partner(self):
        ...
        lbl_title=ttkbootstrap.Label(frame_cero,text='Eliminar Datos de Socio',font='Helvetica',bootstyle='dark')
        ...
        frame_partner_list.bind("<<TreeviewSelect>>",function_select_partner)
        ...
        btn_save_changes=ttkbootstrap.Button(frame_four,text='¿Eliminar Socio?',bootstyle='danger',command=function_delete_partner)
